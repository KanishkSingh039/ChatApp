...
function Register() {
    ...
    <div className="h-full w-full flex flex-col justify-center items-center">
        <form className="h-[40%] w-[30%]  shadow-2xl grid grid-cols-1  rounded-2xl p-4 text-center gap-" onSubmit={onsubmit}>
            ...
            <input className="w-[55%] pl-4 rounded-xl shadow-2xs h-[60%] text-[80%]" placeholder="Please Enter Your Password" type="text" value={password} onChange={(e)=>setpassword(e.target.value)}/>
            </div>
